...
- [ ] [Design cart page](#design-cart-page) (5/6 Points)

  > ⚠️ When adding multiple items of the same product with different sizes, changing the quantity of any item in the cart only changes the quantity of the first item in the list. This makes the list really hard to use in certain scenarios.
